...
public class StringFunctions {
    ...
    @Contract.Requires("end_more_than_start")
    @Contract.Ensures("shift_right_correct")
    ...
    @Contract.Requires("end_more_than_start")
    @Contract.Ensures("shift_left_correct")
    ...
    @Contract.Pure
   static boolean shift_right_correct(int start, int end, char[] array){
       for(int i = start; i< end; i++) {
    ...
    @Contract.Pure
    static boolean end_more_than_start(int start, int end){
        return end > start;
    }


    @Contract.Pure
    static boolean shift_left_correct(int start, int end, char[] array){
        for(int i = start; i< end; i++){
            if (array[i] != old(array)[i+1])
                return false;
        }return true;
